...
(1, 'classifier_vodka/classifier_first/cascade.xml', '', 100, 120, 50, 70, -15, 60, 1),
(2, 'classifier_jd/classifier_second/cascade.xml', '', 80, 180, 60, 65, 0, 80, 1),
...
(2, 1, 1, 'histogram_data/neg_1_rgb.histo', 'histogram_data/neg_1_hsv.histo', 0, 1),
(3, 1, 1, 'histogram_data/neg_2_rgb.histo', 'histogram_data/neg_2_hsv.histo', 0, 1),
...
--
ALTER TABLE `Bottle`
  MODIFY `bottle_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `Histogram`
  MODIFY `histogram_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `Ingredient`
--
ALTER TABLE `Ingredient`
  MODIFY `ingredient_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=152;
--
-- AUTO_INCREMENT for table `Measure`
--
ALTER TABLE `Measure`
  MODIFY `measure_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=810;
--
-- AUTO_INCREMENT for table `Recipe`
--
ALTER TABLE `Recipe`
  MODIFY `recipe_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=175;
--
